...
const CheckoutForm = ({ cls, price }) => {
    ...
    return (
        <div>
            <h2 className="text-4xl font-bold text-center text-purple-500 my-5">Please Pay</h2>
            <form className="card my-10 shadow-2xl w-[350px] md:w-[600px] p-8" onSubmit={handleSubmit}>
                <CardElement
                    className="input"
                    options={{
                        style: {
            ...
            <div className="card shadow-2xl my-5 p-2 w-full md:w-1/3 mx-auto">
                {
